...
Edlo is a modified version of Stephen G. Hartke's "Aurulent Sans":http://www.dafont.com/aurulent-sans-mono.font.

In Snow Leopard, Monaco is my usual default font. I really like it but it's a little too close to Comic Sans, which I just can't take seriously. I found Aurulent Sans which I thought was beautiful, but it was hazardous for programming because the similarities between zeroes and ohs and ones and els were too close for comfort.
...
Click "Downloads" at the top right, then download the zipped source (.tar.gz or .zip). Unarchive and install "edlo.ttf" on your local machine.

h3. Sublime Text 2 Specific

I have these options set up for my User File Preferences:
